    ...
    <section id="process" className="py-32 bg-slate-50 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-24">
          ...
          <p className="text-zinc-500 text-xl md:text-2xl font-medium leading-tight max-w-2xl mx-auto">
            A frictionless, zero-risk process designed for forward-thinking startups.
          </p>
        </div>
        ...
        <div className="mt-24 flex flex-wrap justify-center gap-4">
          <div className="inline-flex items-center gap-3 rounded-full bg-white border border-rose-100 px-6 py-3 text-sm font-bold text-rose-500 shadow-sm">
            <Sparkles size={18} className="text-rose-500" /> NO UPFRONT COST
          </div>
          <div className="inline-flex items-center gap-3 rounded-full bg-white border border-zinc-100 px-6 py-3 text-sm font-bold text-zinc-900 shadow-sm">
            <ShieldCheck size={18} className="text-green-500" /> DEDICATED ENGINEERING
          </div>
          <div className="inline-flex items-center gap-3 rounded-full bg-white border border-zinc-100 px-6 py-3 text-sm font-bold text-zinc-900 shadow-sm">
            <Wallet size={18} className="text-purple-500" /> PAY AFTER COMMITMENT
          </div>
        </div>
      </div>
    </section>
