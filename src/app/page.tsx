            ...
            <div className="container mx-auto max-w-6xl">
              <div className="text-center p-8 md:p-24 rounded-[2.5rem] md:rounded-[3.5rem] bg-white/5 border border-white/10 relative overflow-hidden shadow-2xl">
                 ...
                 >
                    ...
                    <Button 
                      onClick={openBooking}
                      className="btn-pill min-h-[44px] h-14 md:h-18 px-10 md:px-16 text-base md:text-xl font-bold bg-white text-zinc-950 hover:bg-zinc-200 shadow-[0_0_40px_rgba(255,255,255,0.1)] flex items-center gap-2 group"
                    >
                      Get My Free Demo
